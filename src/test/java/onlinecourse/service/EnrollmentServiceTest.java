...
class EnrollmentServiceTest {
    ...
    void enroll() {
        ...
        EnrollmentDTO createdEnrollment = enrollmentService.enroll(1L, 1L);

        assertNotNull(createdEnrollment);
        assertEquals(student.getId(), createdEnrollment.getStudentId());
        assertEquals(lecture.getId(), createdEnrollment.getLectureId());
    ...
    void enrollMultiple() {
        ...
        List<EnrollmentDTO> enrollments = enrollmentService.enrollMultiple(1L, Arrays.asList(1L, 2L));

        assertNotNull(enrollments);
        assertEquals(2, enrollments.size());
        assertEquals(lecture1.getId(), enrollments.get(0).getLectureId());
        assertEquals(lecture2.getId(), enrollments.get(1).getLectureId());
